      ...
      <div class="sidebar-content">
          ...
          <ng-container *ngFor="let item of primaryNavItems">
            <div class="nav-item-container">
              ...
              >
                ...
                <mat-icon
                  *ngIf="item.children && item.children.length && isExpanded"
                  class="expand-icon"
                >
                  {{
        ...
        <div class="user-section">
          ...
          >
            ...
            <mat-icon *ngIf="isExpanded" class="user-menu-icon"
  ...
  styles: [
    `
      .sidebar {
        ...
        width: 72px;
        height: 100vh;
        background-color: var(--sidebar-bg, rgba(26, 26, 26, 0.95));
      ...
      .sidebar.overlay-mode.expanded + .backdrop {
        opacity: 1;
        visibility: visible;
      }
...
export class SidebarComponent implements OnInit {
      ...
      children: [
        {
          ...
          icon: "list",
          label: "All Courses",
          translatedLabel: "All Courses",
        },
        {
          path: "/formations/my-courses",
          icon: "bookmark",
          label: "My Courses",
          translatedLabel: "My Courses",
        },
        {
          path: "/formations/certificates",
          icon: "card_membership",
          label: "Certificates",
          translatedLabel: "Certificates",
        },
      ],
    },
    {
  ...
  private updateExpandedGroups() {
    ...
    this.primaryNavItems.forEach((item) => {
      if (
        item.children &&
        item.children.some((child) => this.currentUrl.startsWith(child.path))
      ) {
